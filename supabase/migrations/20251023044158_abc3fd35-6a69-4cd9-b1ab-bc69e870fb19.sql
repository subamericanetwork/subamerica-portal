-- Remove email sending logic from approve_artist_application function
-- Email sending is now handled by the frontend
CREATE OR REPLACE FUNCTION public.approve_artist_application(application_id uuid, admin_id uuid, admin_notes text DEFAULT NULL::text)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
